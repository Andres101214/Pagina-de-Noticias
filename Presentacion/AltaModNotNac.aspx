<%@ Page Title="" Language="C#" MasterPageFile="~/MPUsuario.master" AutoEventWireup="true" CodeFile="AltaModNotNac.aspx.cs" Inherits="AltaModNotNac" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
                <h1>Alta y Modificación Noticia Nacional</h1>
    <table border="1" align="center" class="auto-style5">
        <tr>
            ...
            <td class="auto-style3">
                <asp:TextBox ID="TxtCodInt" runat="server" Width="222px" 
                    ></asp:TextBox>
            &nbsp;&nbsp;<asp:Button ID="BtnBuscarNac" runat="server" Text="Buscar" 
                    onclick="BtnBuscarNac_Click" />
                <br />
                <asp:Label ID="LblNacional" runat="server"></asp:Label>
                <br />
            </td>
        </tr>
        <tr>
            <td class="auto-style1" colspan="1">
                Sección: </td>
            <td>
                <asp:TextBox ID="TxtSeccionNac" runat="server" Width="222px"></asp:TextBox>
                <asp:Button ID="BuscarSecc" runat="server" OnClick="BuscarSecc_Click" Text="Buscar Seccion" />
                <br />
        ...
        <tr>
            <td class="auto-style1" colspan="1">
                Importancia:</td>
            <td>
                <asp:TextBox ID="TxtImportanciaNac" runat="server" Width="222px"></asp:TextBox>
            </td>
        ...
        <tr>
            <td class="auto-style1" colspan="1">
                Título:</td>
            <td>
                <asp:TextBox ID="TxtTituloNac" runat="server" Width="222px"></asp:TextBox>
            </td>
        ...
        <tr>
            <td class="auto-style1" colspan="1">
                Cuerpo:</td>
            <td>
                <asp:TextBox ID="TxtCuerpoNac" runat="server" Height="160px" Width="381px"></asp:TextBox>
            </td>
        ...
        <tr>
            <td class="style8" colspan="2">
                <asp:Button ID="BtnAltaNac" runat="server" Text="       Alta             " 
                    onclick="BtnAlta_Click" style="text-align: center" Height="30px" 
                    Width="109px" />&nbsp;&nbsp;
                &nbsp;&nbsp;<asp:Button ID="BtnModificarNac" runat="server" Text="Modificar" 
